...
story = {
    ...
    "compass": {
        "Superliminal Space": "This is a superliminal place. Superliminal is a term used in psychology and physiology to describe mental activity that is above the threshold of the subconscious. It is the opposite of subliminal, which refers to mental activity that is below the threshold of conscious awareness. The term supraliminal is also used to describe mental activity that is above the threshold of consciousness.",
    },

    "NPCs": {
        "Aname": "Hello, I am a Non-Playable Character!",
        ...
        "Cocroach-A": "The Cocroach isn't here anymore",
    ...
    "Enemies": {
        ...
        "Cocroach-L": "You fight until you don't have any more energy even though the beast doesn't make a single move. The cockroach looks at you with sorrow and disappointment. You find a hill up which you can go back.."
